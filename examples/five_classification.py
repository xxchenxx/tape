...
@registry.register_task('five_classification', num_labels=5)
class fiveClassificationDataset(Dataset):
...
registry.register_task_model(
    'five_classification', 'transformer', ProteinBertForSequenceClassification, force_reregister=True)
from tape import UniRepForSequenceClassification
from tape import ProteinResNetForSequenceClassification
registry.register_task_model(
    'five_classification', 'unirep', UniRepForSequenceClassification, force_reregister=True)
registry.register_task_model(
    'five_classification', 'resnet', ProteinResNetForSequenceClassification, force_reregister=True)
