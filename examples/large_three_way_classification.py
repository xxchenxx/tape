...
@registry.register_task('large_three_way_classification', num_labels=3)
class LargeThreeWayClassificationDataset(Dataset):
...
registry.register_task_model(
    'large_three_way_classification', 'transformer', ProteinBertForSequenceClassification, force_reregister=True)
