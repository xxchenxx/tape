...
@registry.register_task('regression', num_labels=1)
class BinaryClassificationDataset(Dataset):
    ...
    def __getitem__(self, index: int):
        ...
        return token_ids, input_mask, float(label)
...
registry.register_task_model(
    'regression', 'transformer', ProteinBertForValuePrediction, force_reregister=True)
from tape import UniRepForValuePrediction
from tape import ProteinResNetForValuePrediction
registry.register_task_model(
    'regression', 'unirep', UniRepForValuePrediction, force_reregister=True)
registry.register_task_model(
    'regression', 'resnet', ProteinResNetForValuePrediction, force_reregister=True)
